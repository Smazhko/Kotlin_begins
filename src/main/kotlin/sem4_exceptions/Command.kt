...
class CmdHelp : Command {
     companion object{
         fun run() {
             ...
             result.append("       - export сохраняет всю информацию из книги в файл phonebook.json;\n")
...
class CmdExport(private val dataBase: MutableList<Person>): Command{
    var jsonString = ""
    ...
    fun run() {
        ...
        File("phonebook.json").writeText(jsonString)
